    ...
    data: JSON.stringify(
      {
        ...
        blocks: [
          ...
          {
            type: 'h3',
            content: '8.4 topAndBottom（上下型环绕）',
            style: {
              fontWeight: 'bold',
              fontSize: '14px',
              marginTop: '10px',
          ...
          {
            type: 'h3',
            content: '8.6 inFrontOfText（浮于文字上方）',
            style: {
              fontWeight: 'bold',
              fontSize: '14px',
              marginTop: '10px',
          ...
          {
            type: 'p',
            content: '下一页将展示分页符的效果。在 DOCX 导出时，此处会强制分页。',
            style: {
              marginBottom: '10px',
            },
          },
          ...
          {
            type: 'p',
            content: '这是分页后的内容，表示 pageBreak 已生效。',
            style: {
              marginTop: '10px',
              marginBottom: '10px',
            },
          ...
          },
          {
            type: 'p',
            content: [
              { text: '字间距 0.2em', style: { letterSpacing: '0.2em' } },
              { text: ' vs ' },
              { text: '字间距 0.5em', style: { letterSpacing: '0.5em', color: '#e74c3c' } },
            ],
            style: {
              marginBottom: '1em',
            },
          },
          {
            type: 'p',
            content:
              '本段行高设置为 18pt，确保多行文本具有固定垂直间距。段落边框也可使用 pt 单位，如左侧 3pt 蓝色边框。',
            style: {
              fontSize: '12pt',
              lineHeight: '18pt',
              marginBottom: '1em',
